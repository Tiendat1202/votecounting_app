  ...
  return (
    <div className="login-container">
      ...
      <p style={{ color: "#64748b", marginBottom: 16 }}>
        Admin dùng tài khoản seed sẵn. Inspector và supervisor cần được admin duyệt trước khi đăng nhập.
      </p>
      ...
      <div className="login-footer" style={{ display: "grid", gap: 8 }}>
        <span>Chưa có tài khoản? <Link to="/register">Đăng ký inspector / supervisor</Link></span>
